...
@section('contenido')
    <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-white shadow p-6">
            <form method="POST" action="{{route('perfil.store')}}" class="mt-10 md:mt-8" enctype="multipart/form-data">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5">
                    <label for="imagen" class="mb-3 block uppercase text-gray-500 font-bold">
                        Imagen Perfil
                    </label>
                    <input 
                    id="imagen"
