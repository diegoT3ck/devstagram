...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-5/12 p-5">
           <img src="{{ asset('img/login.jpg') }}" alt="Imagen registros de usuarios">
        </div>

        <div class="md:w-4/12 bg-white p-6 rounded-t-lg shadow-xl">
            <form action="{{route('login')}}" method="POST">
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember"><label for="" class="text-sm text-gray-500 ">Mantener Mi session abierta </label> 
                </div>
